...
export type Status = "TO_DO" | "IN_PROGRESS";

// Converts JSON strings to/from your types
// and asserts the results of JSON.parse at runtime
export class Convert {
  public static toTask(json: string): Task[] {
    return cast(JSON.parse(json), a(r("Task")));
  }

  public static taskToJson(value: Task[]): string {
    return JSON.stringify(uncast(value, a(r("Task"))), null, 2);
  }
}
...
const typeMap: any = {
  "Task": o([
    { json: "id", js: "id", typ: "" },
    { json: "taskNumber", js: "taskNumber", typ: "" },
    { json: "name", js: "name", typ: "" },
    { json: "description", js: "description", typ: "" },
    { json: "status", js: "status", typ: r("Status") },
    { json: "priority", js: "priority", typ: r("Priority") },
    { json: "percentageOfProgress", js: "percentageOfProgress", typ: 0 },
    { json: "startDate", js: "startDate", typ: Date },
    { json: "endDate", js: "endDate", typ: Date },
    { json: "childTasks", js: "childTasks", typ: a(r("Task")) },
  ], false),
  "Priority": [
    "HIGH",
    "MEDIUM",
